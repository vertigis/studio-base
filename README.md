...
_Updated on: Thu Apr 16 20:01:26 PDT 2026_
- [Links](#links)
...
- [VertiGIS Studio-Base: An
  ...
  - [On Windows: Testing with Docker Desktop and
    WSL](#on-windows-testing-with-docker-desktop-and-wsl)
...
- [This
  Release](https://github.com/vertigis/studio-base/releases/v1.1.1016.325503-r24545444523)
  ( v1.1.1016.325503-r24545444523 )
  - [Image](https://github.com/vertigis/studio-base/pkgs/container/studio%2fbase/803025746?tag=v1.1.1016.325503-r24545444523)
...
## On Windows: Testing with Docker Desktop and WSL

If you wish to test with Docker Desktop, you will need to following
installations instructions (see below). Please note that Docker Desktop
and WSL environments are not production grade environments. However,
these tools are extremely useful ways of testing locally. - [Docker
...
> cd ~/deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.1016.325503-r24545444523.tar.gz | tar -xz
# If desired, use git:
> git clone --depth 1 --branch v1.1.1016.325503-r24545444523 https://github.com/vertigis/studio-base ~/deploy-studio
> cd ~/deploy-studio
...
> ssh -L localhost:7780:localhost:7780 user@host ~/deploy-studio/tools activate
```
