...
- [This
  Release](https://github.com/vertigis/studio-base/releases/v1.1.632.232243-r14136429989)
  ( v1.1.632.232243-r14136429989 )
...
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.632.232243-r14136429989.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
```
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.632.232243-r14136429989.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip
```

``` git
> git clone --depth 1 --branch v1.1.632.232243-r14136429989 https://github.com/vertigis/studio-base deploy-studio
> cd deploy-studio
```
