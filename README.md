...
- [This
  Release](https://github.com/vertigis/studio-base/releases/v1.1.609.227092-r13687589875)
  ( v1.1.609.227092-r13687589875 )
...
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.609.227092-r13687589875.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
```
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.609.227092-r13687589875.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip
```

``` git
> git clone --depth 1 --branch v1.1.609.227092-r13687589875 https://github.com/vertigis/studio-base deploy-studio
> cd deploy-studio
```
