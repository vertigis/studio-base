...
- [This
  Release](https://github.com/vertigis/studio-base/releases/v1.1.632.232243-r14805264603)
  ( v1.1.632.232243-r14805264603 )
...
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.632.232243-r14805264603.tar.gz | tar -xz

# Using cmd on Windows
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.632.232243-r14805264603.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.632.232243-r14805264603.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip

# Using git
> git clone --depth 1 --branch v1.1.632.232243-r14805264603 https://github.com/vertigis/studio-base deploy-studio
> cd deploy-studio
```
...
> sudo ./install-tools.sh; exec sudo su - $USER
