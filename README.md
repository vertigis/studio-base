...
- [This
  Release](https://github.com/vertigis/studio-base/releases/vtest-r13467400668)
  ( vtest-r13467400668 )
...
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/vtest-r13467400668.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
```
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base/archive/refs/tags/vtest-r13467400668.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip
```

``` git
> git clone --depth 1 --branch vtest-r13467400668 https://github.com/vertigis/studio-base deploy-studio
> cd deploy-studio
```
