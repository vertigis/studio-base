...
- [This
  Release](https://github.com/vertigis/studio-base/releases/v1.1.834.277132-r18581093616)
  ( v1.1.834.277132-r18581093616 )
...
> cd ~/deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base/archive/refs/tags/v1.1.834.277132-r18581093616.tar.gz | tar -xz
# If desired, use git:
> git clone --depth 1 --branch v1.1.834.277132-r18581093616 https://github.com/vertigis/studio-base ~/deploy-studio
> cd ~/deploy-studio
